...
def settings():
    ...
    "./data/models/NAmodel_08_EastGL 25.5_additionalPiles.gwb",
    # "./data/models/NAmodel_08_0.5springs_EastGL 25.5_additionalPiles.gwb",
    # "./data/models/NAmodel_08_0.5weaksprings_EastGL 25.5_additionalPiles.gwb",
    # "./data/models/NAmodel_08_2springs_EastGL 25.5_additionalPiles.gwb"
