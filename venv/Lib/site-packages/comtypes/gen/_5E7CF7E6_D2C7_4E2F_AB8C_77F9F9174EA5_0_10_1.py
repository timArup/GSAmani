...
IComAuto._methods_ = [
    COMMETHOD(
        [dispid(1), helpstring('method Open')],
        HRESULT,
        'Open',
        (['in'], BSTR, 'sPathName'),
    ...
    COMMETHOD(
        [dispid(2), helpstring('method Analyse')],
        HRESULT,
        'Analyse',
    ...
    COMMETHOD(
        [dispid(3), helpstring('method Save')],
        HRESULT,
        'Save',
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ),
    COMMETHOD(
        [dispid(4), helpstring('method SaveAs')],
        HRESULT,
        'SaveAs',
        (['in'], BSTR, 'sPathName'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(5), helpstring('method Delete')],
        HRESULT,
        'Delete',
        (['in'], BSTR, 'sContent'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(6), helpstring('method Close')],
        HRESULT,
        'Close',
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ),
    COMMETHOD(
        [dispid(7), helpstring('method UpdateViews')],
        HRESULT,
        'UpdateViews',
    ),
    COMMETHOD(
        [dispid(8), helpstring('method NewFile')],
        HRESULT,
        'NewFile',
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ),
    COMMETHOD(
        [dispid(9), helpstring('method GwaCommand')],
        HRESULT,
        'GwaCommand',
        (['in'], BSTR, 'sCommand'),
    ...
    COMMETHOD(
        [dispid(10), helpstring('method PrintView')],
        HRESULT,
        'PrintView',
        (['in'], BSTR, 'sView'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(11), helpstring('method HighestView')],
        HRESULT,
        'HighestView',
        (['in'], BSTR, 'sViewType'),
    ...
    COMMETHOD(
        [dispid(12), helpstring('method ViewExist')],
        HRESULT,
        'ViewExist',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(13), helpstring('method ViewName')],
        HRESULT,
        'ViewName',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(14), helpstring('method NumArg')],
        HRESULT,
        'NumArg',
        (['in'], BSTR, 'sLine'),
    ...
    COMMETHOD(
        [dispid(15), helpstring('method Arg')],
        HRESULT,
        'Arg',
        (['in'], c_int, 'iIndex'),
        (['in'], BSTR, 'sLine'),
    ...
    COMMETHOD(
        [dispid(16), helpstring('method SaveViewToFile')],
        HRESULT,
        'SaveViewToFile',
        (['in'], BSTR, 'sView'),
        (['in'], BSTR, 'sFileType'),
    ...
    COMMETHOD(
        [dispid(17), helpstring('method Output_Init')],
        HRESULT,
        'Output_Init',
        (['in'], c_int, 'iFlags'),
        (['in'], BSTR, 'sAxis'),
    ...
    COMMETHOD(
        [dispid(18), helpstring('method Output_SetStage')],
        HRESULT,
        'Output_SetStage',
        (['in'], c_int, 'iStage'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(19), helpstring('method Output_DataTitle')],
        HRESULT,
        'Output_DataTitle',
        (['in'], c_int, 'iFlags'),
    ...
    COMMETHOD(
        [dispid(20), helpstring('method Output_IsDataRef')],
        HRESULT,
        'Output_IsDataRef',
        (['in'], c_int, 'iFlags'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(21), helpstring('method Output_UnitString')],
        HRESULT,
        'Output_UnitString',
        (['out', 'retval'], POINTER(BSTR), 'sUnit')
    ),
    COMMETHOD(
        [dispid(22), helpstring('method Output_UnitFactor')],
        HRESULT,
        'Output_UnitFactor',
        (['out', 'retval'], POINTER(c_float), 'fFactor')
    ),
    COMMETHOD(
        [dispid(23), helpstring('method Output_DataExist')],
        HRESULT,
        'Output_DataExist',
        (['in'], c_int, 'iRef'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(24), helpstring('method Output_NumElemPos')],
        HRESULT,
        'Output_NumElemPos',
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(25), helpstring('method Output_1DElemPos')],
        HRESULT,
        'Output_1DElemPos',
        (['in'], c_int, 'iPos'),
    ...
    COMMETHOD(
        [dispid(26), helpstring('method Output_Extract')],
        HRESULT,
        'Output_Extract',
        (['in'], c_int, 'iRef'),
        (['in'], c_int, 'iPos'),
    ...
    COMMETHOD(
        [dispid(27), helpstring('method HighestCase')],
        HRESULT,
        'HighestCase',
        (['in'], BSTR, 'sCaseOp'),
    ...
    COMMETHOD(
        [dispid(28), helpstring('method CaseExist')],
        HRESULT,
        'CaseExist',
        (['in'], BSTR, 'sCaseOp'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(29), helpstring('method CaseName')],
        HRESULT,
        'CaseName',
        (['in'], BSTR, 'sCaseOp'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(30), helpstring('method CaseNumPerm')],
        HRESULT,
        'CaseNumPerm',
        (['in'], BSTR, 'sCaseOp'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(31), helpstring('method CasePermDesc')],
        HRESULT,
        'CasePermDesc',
        (['in'], BSTR, 'sCaseOp'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(32), helpstring('method CasePermString')],
        HRESULT,
        'CasePermString',
        (['in'], BSTR, 'sCaseOp'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(33), helpstring('method CasePermAnalFactor')],
        HRESULT,
        'CasePermAnalFactor',
        (['in'], BSTR, 'sCaseOp'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(34), helpstring('method Output_Extract_CurPerm')],
        HRESULT,
        'Output_Extract_CurPerm',
        (['out', 'retval'], POINTER(c_int), 'iPerm')
    ),
    COMMETHOD(
        [dispid(35), helpstring('method CaseResultsExist')],
        HRESULT,
        'CaseResultsExist',
        (['in'], BSTR, 'sCaseOp'),
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(36), helpstring('method CaseTask')],
        HRESULT,
        'CaseTask',
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(37), helpstring('method TaskStatus')],
        HRESULT,
        'TaskStatus',
        (['in'], c_int, 'iRef'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(38), helpstring('method ProcessID')],
        HRESULT,
        'ProcessID',
        (['out', 'retval'], POINTER(c_int), 'iID')
    ),
    COMMETHOD(
        [dispid(39), helpstring('method Gen_NodeAt')],
        HRESULT,
        'Gen_NodeAt',
        (['in'], c_double, 'dX'),
        (['in'], c_double, 'dY'),
    ...
    COMMETHOD(
        [dispid(40), helpstring('method Gen_SectionMatchDesc')],
        HRESULT,
    ...
    COMMETHOD(
        [dispid(41), helpstring('method VersionString')],
        HRESULT,
        'VersionString',
        (['out', 'retval'], POINTER(BSTR), 'sVersion')
    ),
    COMMETHOD(
        [dispid(42), helpstring('method SectionUsage')],
        HRESULT,
        'SectionUsage',
        (['in'], c_int, 'iSec'),
    ...
    COMMETHOD(
        [dispid(43), helpstring('method Gen_SectTransltnGsRevit')],
        HRESULT,
        'Gen_SectTransltnGsRevit',
        (['in'], BSTR, 'nameIn'),
    ...
    COMMETHOD(
        [dispid(44), helpstring('method MembNumElem')],
        HRESULT,
        'MembNumElem',
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(45), helpstring('method MembElemNum')],
        HRESULT,
        'MembElemNum',
        (['in'], c_int, 'iRef'),
        (['in'], c_int, 'iIdx'),
    ...
    COMMETHOD(
        [dispid(46), helpstring('method ElemMembNum')],
        HRESULT,
        'ElemMembNum',
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(47), helpstring('method Tool_UpdateElemSections')],
        HRESULT,
        'Tool_UpdateElemSections',
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ),
    COMMETHOD(
        [dispid(48), helpstring('method Tool_ResetMemberSections')],
        HRESULT,
        'Tool_ResetMemberSections',
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ),
    COMMETHOD(
        [dispid(49), helpstring('method IsItemIncluded')],
        HRESULT,
        'IsItemIncluded',
        (['in'], BSTR, 'sType'),
        (['in'], c_int, 'iIndex'),
    ...
    COMMETHOD(
        [dispid(53), helpstring('method GetSidTagValue')],
        HRESULT,
        'GetSidTagValue',
        (['in'], BSTR, 'sKey'),
        (['in'], c_int, 'iRecord'),
    ...
    COMMETHOD(
        [dispid(54), helpstring('method WriteSidTagValue')],
        HRESULT,
        'WriteSidTagValue',
        (['in'], BSTR, 'sKey'),
        (['in'], c_int, 'iRecord'),
    ...
    COMMETHOD(
        [dispid(55), helpstring('method NodeCoor')],
        HRESULT,
        'NodeCoor',
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(56), helpstring('method Renumber_Init')],
        HRESULT,
        'Renumber_Init',
        (['in'], GsaEntity, 'option'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(57), helpstring('method Renumber_SetTo')],
        HRESULT,
        'Renumber_SetTo',
        (['in'], GsaEntity, 'option'),
        ([], c_int, 'oldRef'),
    ...
    COMMETHOD(
        [dispid(58), helpstring('method Renumber_Go')],
        HRESULT,
        'Renumber_Go',
        (['in'], GsaEntity, 'option'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(59), helpstring('method SetLocale')],
        HRESULT,
        'SetLocale',
        (['in'], Locale, 'Locale'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(60), helpstring('method Output_Init_Arr')],
        HRESULT,
        'Output_Init_Arr',
        (['in'], c_int, 'iFlags'),
        (['in'], BSTR, 'sAxis'),
    ...
    COMMETHOD(
        [dispid(61), helpstring('method Output_Extract_Arr')],
        HRESULT,
        'Output_Extract_Arr',
        (['in'], c_int, 'iRef'),
    ...
    COMMETHOD(
        [dispid(62), helpstring('method EntitiesInList')],
        HRESULT,
        'EntitiesInList',
        (['in'], BSTR, 'sList'),
    ...
    COMMETHOD(
        [dispid(63), helpstring('method CopyView')],
        HRESULT,
        'CopyView',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(64), helpstring('method RenameView')],
        HRESULT,
        'RenameView',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(65), helpstring('method DeleteView')],
        HRESULT,
        'DeleteView',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(66), helpstring('method GetViewCaseList')],
        HRESULT,
        'GetViewCaseList',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(67), helpstring('method SetViewCaseList')],
        HRESULT,
        'SetViewCaseList',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(68), helpstring('method GetViewDisplayList')],
        HRESULT,
        'GetViewDisplayList',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(69), helpstring('method SetViewDisplayList')],
        HRESULT,
        'SetViewDisplayList',
        (['in'], BSTR, 'sViewType'),
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(70), helpstring('method RescaleViewData')],
        HRESULT,
        'RescaleViewData',
        (['in'], c_int, 'idxView'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(71), helpstring('method NodeConnectedElem')],
        HRESULT,
        'NodeConnectedEnt',
    ...
    COMMETHOD(
        [dispid(72), helpstring('method LogFeatureUsage')],
        HRESULT,
        'LogFeatureUsage',
        (['in'], BSTR, 'featureIn')
    ),
    COMMETHOD(
        [dispid(73), helpstring('method Nodes: extract node objects using an array of node references')],
        HRESULT,
        'Nodes',
    ...
    COMMETHOD(
        [dispid(74), helpstring('method SetNodes: set node objects into the model')],
        HRESULT,
        'SetNodes',
    ...
    COMMETHOD(
        [dispid(75), helpstring('method Elements: extract element objects using an array of element references')],
        HRESULT,
        'Elements',
    ...
    COMMETHOD(
        [dispid(76), helpstring('method SetElements: set element objects into the model')],
        HRESULT,
        'SetElements',
    ...
    COMMETHOD(
        [dispid(77), helpstring('method Sections: extract section objects using an array of section references')],
        HRESULT,
        'Sections',
    ...
    COMMETHOD(
        [dispid(78), helpstring('method SetSections: set section objects into the model')],
        HRESULT,
        'SetSections',
    ...
    COMMETHOD(
        [dispid(79), helpstring('method MembCoorOnCurve')],
        HRESULT,
        'MembCoorOnCurve',
        (['in'], c_int, 'iMembRef'),
        (['out'], POINTER(c_double), 'pX'),
    ...
    COMMETHOD(
        [dispid(80), helpstring('method MappingDBPath')],
        HRESULT,
        'MappingDBPath',
    ...
    COMMETHOD(
        [dispid(81), helpstring('method Output_Extract_CutAssembly: extract cut section forces')],
        HRESULT,
    ...
    COMMETHOD(
        [dispid(82), helpstring('method ElemIsVertical')],
        HRESULT,
        'ElemIsVertical',
        (['in'], c_int, 'iElem'),
        (['in', 'optional'], c_int, 'eSel', 3),
    ...
    COMMETHOD(
        [dispid(83), helpstring('method ElemIsHorizontal')],
        HRESULT,
        'ElemIsHorizontal',
        (['in'], c_int, 'iElem'),
        (['in', 'optional'], c_int, 'eSel', 3),
    ...
    COMMETHOD(
        [dispid(87), helpstring('method ViewRefFromName')],
        HRESULT,
        'ViewRefFromName',
        (['in'], BSTR, 'sViewType'),
        (['in'], BSTR, 'Name'),
    ...
    COMMETHOD(
        [dispid(88), helpstring('method createNewView')],
        HRESULT,
        'CreateNewView',
        (['in'], BSTR, 'Name'),
    ...
    COMMETHOD(
        [dispid(89), helpstring('method SetViewContour')],
        HRESULT,
        'SetViewContour',
        (['in'], c_int, 'idxView'),
        (['in'], c_int, 'iDataRef'),
    ...
    COMMETHOD(
        [dispid(90), helpstring('method SetViewDiagram')],
        HRESULT,
        'SetViewDiagram',
        (['in'], c_int, 'idxView'),
        (['in'], c_int, 'iDataRef'),
    ...
    COMMETHOD(
        [dispid(91), helpstring('method SetViewLabels')],
        HRESULT,
        'SetViewLabels',
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(92), helpstring('method SetViewOrientation')],
        HRESULT,
        'GetViewOrientation',
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(93), helpstring('method SetViewOrientation')],
        HRESULT,
        'SetViewOrientation',
        (['in'], c_int, 'idxView'),
    ...
    COMMETHOD(
        [dispid(94), helpstring('method DesignTaskStatus')],
        HRESULT,
        'DesignTaskStatus',
        (['in'], c_int, 'idxTask'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(95), helpstring('method Design')],
        HRESULT,
        'DESIGN',
        (['in'], c_int, 'idxTask'),
    ...
    COMMETHOD(
        [dispid(96), helpstring('method Members: extract member objects using an array of references')],
        HRESULT,
        'Members',
    ...
    COMMETHOD(
        [dispid(97), helpstring('method SetMembers: set member objects into the model')],
        HRESULT,
        'SetMembers',
    ...
    COMMETHOD(
        [dispid(98), helpstring('method Tool_GetElemLength')],
        HRESULT,
        'Tool_GetEntLength',
        (['in'], c_int, 'idxElem'),
        (['in'], GsaEntity, 'entityType'),
    ...
    COMMETHOD(
        [dispid(99), helpstring('method SetViewBaseSettings')],
        HRESULT,
        'SetViewBaseSettings',
        (['in'], c_int, 'idxView'),
        (['in'], BSTR, 'savedViewGwa'),
    ...
    COMMETHOD(
        [dispid(100), helpstring('method RescaleViewToFit')],
        HRESULT,
        'RescaleViewToFit',
        (['in'], c_int, 'idxView'),
        (['out', 'retval'], POINTER(c_short), 'retCode')
    ...
    COMMETHOD(
        [dispid(101), helpstring('method DisplayGsaWindow')],
        HRESULT,
        'DisplayGsaWindow',
        (['in'], VARIANT_BOOL, 'bDisplay')
    ),
    COMMETHOD(
        [dispid(102), helpstring('method Output_BeamForces')],
        HRESULT,
        'Output_BeamForces',
    ...
    COMMETHOD(
        [dispid(103), helpstring('method ReindexCasesAndTasks')],
        HRESULT,
        'ReindexCasesAndTasks',
    ),
    COMMETHOD(
        [dispid(104), helpstring('method CreateElementsFromMembers')],
        HRESULT,
    ...
    COMMETHOD(
        [dispid(105), helpstring('method ExportToCsv')],
        HRESULT,
        'ExportToCsv',
        (['in'], BSTR, 'pathname'),
        (['in'], c_int, 'numPoint'),
...
__all__ = [
    'FABRIC', 'REF_FORCE_CONSTR', 'MaterialType', 'RD_X',
    'REF_STRESS_EL2D_AX', 'GsRevit_SectTrnsDir', 'REF_STRAIN_EL1D',
    'QUAD8', 'ROD', 'REF_STRESS_EL2D_PRJ', 'REF_MOMENT_EL2D_PRJ',
    'DAMPER', 'REF_STRESS_EL3D_AX', 'BRICK8', 'REF_STRESS_EL3D_DRV',
    'GsaSection', 'SPRING', 'WEDGE6', 'RD_ENC', 'LOC_EN_GB',
    'DesignOption', 'REF_STL_UTIL', 'TIE', 'RD_RPIN', 'RD_PIN',
    'REF_STRESS_EL1D_DRV', 'IComAuto', 'ElementType', 'STRUT',
    'CONCRETE', 'ELEMENT', 'REF_DISP_EL3D', 'GsRevit_Usage',
    'GsaMember', 'GsaEntity', 'REF_DISP', 'REF_FORCE_EL1D',
    'GsaViewOrientation', 'RD_ZZ', 'METRIC', 'STEEL',
    'REF_DISP_EL1D_REL', 'REF_STRESS_EL1D', 'FRP', 'QUAD4',
    'IMPERIAL', 'REF_VEL', 'REF_DISP_EL2D', 'ComAuto', 'BEAM',
    'RD_DIS', 'TIMBER', 'REF_FORCE_EL2D_DRV', 'ALUMINIUM', 'RD_Z',
    'SOIL', 'REF_ACC', 'GsRevit_Units', 'ResHeader', 'BAR', 'CHECK',
    'RD_YY', 'Locale', 'NODE', 'REF_SED_AVG_EL1D', 'REF_SOIL_NODAL',
    'REVIT_TO_GSA', 'RD_ROT', 'UNDEF', 'PYRAMID5', 'GsaElement',
    'LINK', 'RD_ALL', 'GSA_TO_REVIT', 'LOC_SYSTEM', 'SPACER',
    'REF_FORCE_EL2D_PRJ', 'REF_FORCE_NODAL', 'COLUMNS',
    'REF_SED_EL1D', 'REF_FORCE_ASSEM', 'GsaResults', 'TETRA4',
    'GLASS', 'DESIGN', 'GENERIC', 'RD_Y', 'FRAMING', 'CABLE',
    'REF_STRESS_EL2D_DRV', 'REBAR', 'REF_DISP_ASSEM', 'REF_DISP_EL1D',
    'REF_RC_SLAB_REINF', 'TRI6', 'TRI3', 'RestraintDir', 'MEMBER',
    'REF_REAC', 'RD_FREE', 'RD_XX', 'REF_MASS_NODAL', 'GsaNode'
]

_check_version('1.1.14', 1665153880.000000)
