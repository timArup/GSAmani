...
IFontDisp = Font
__all__ = [ 'OLE_TRISTATE', 'Gray', 'OLE_YPOS_CONTAINER', 'Default',
           'FONTITALIC', 'IFontDisp', 'IPictureDisp', 'OLE_HANDLE',
           'IFontEventsDisp', 'LoadPictureConstants',
           'OLE_XSIZE_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_OPTEXCLUSIVE', 'Color', 'FONTNAME', 'StdFont',
           'OLE_XPOS_HIMETRIC', 'Monochrome', 'OLE_XPOS_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'IPicture', 'OLE_CANCELBOOL',
           'StdPicture', 'Picture', 'Checked', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_PIXELS', 'FONTSIZE', 'OLE_YPOS_HIMETRIC',
           'OLE_XSIZE_PIXELS', 'OLE_XSIZE_CONTAINER',
           'OLE_YSIZE_PIXELS', 'Unchecked', 'OLE_COLOR',
           'OLE_XPOS_PIXELS', 'FontEvents', 'FONTBOLD', 'IFont',
           'Font', 'OLE_YSIZE_CONTAINER', 'VgaColor',
           'FONTUNDERSCORE']
